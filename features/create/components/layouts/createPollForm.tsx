...
export function CreatePollForm() {
  ...
  return (
    <form onSubmit={handleCreateNew} className='w-full flex flex-col items-center'>
      <Input value={pollTitle} onChange={(e) => setPollTitle(e.target.value)} placeholder='Poll name e.g president electiion' className='mt-6 w-1/3' />
